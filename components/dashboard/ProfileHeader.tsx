    ...
    <DashboardCard>
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          <p className="text-caption uppercase tracking-[0.16em] text-slate-500 dark:text-slate-400">
            IELTS MASTERY DASHBOARD
          </p>
          <h1 className="text-h3 font-semibold tracking-tight text-slate-900 dark:text-slate-50">
        ...
        <div className="flex flex-wrap items-center gap-3 text-caption">
          <div className="flex items-center gap-2 rounded-full bg-success/10 px-3 py-1.5 text-success dark:bg-success/95/30 dark:text-success/80">
