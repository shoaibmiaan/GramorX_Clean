...
const ReadingQuestionInfoMatch: React.FC<RendererProps> = ({ question, value, setAnswer, answers, mode }) => {
  ...
  return (
    <MatchingGroup prompt={question.groupPrompt} options={pool}>
      <div className="flex items-center gap-2 text-xs text-foreground">
        <span className="min-w-[60px] font-semibold">Paragraph</span>
        {renderSelect}
      </div>
    </MatchingGroup>
  );
...
export default ReadingQuestionInfoMatch;
