...
export default function CoherenceGuide() {
  return (
    <Section className="py-16 bg-lightBg dark:bg-gradient-to-b dark:from-dark/70 dark:to-darker/90">
      <Container>
        <h1 className="text-h2 font-semibold tracking-tight">Coherence & Cohesion</h1>
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-2">
          <Card className="p-4">
            <h2 className="text-h4 font-semibold">Given → New principle</h2>
          ...
          <Card className="p-4">
            <h2 className="text-h4 font-semibold">Paragraphing that works</h2>
          ...
          <Card className="p-4">
            <h2 className="text-h4 font-semibold">Cohesive devices (use sparingly)</h2>
            <ul className="mt-3 list-disc pl-6 text-small">
          ...
          <Card className="p-4">
            <h2 className="text-h4 font-semibold">Signposting without clutter</h2>
            <p className="text-small mt-2">
          ...
          <Card className="p-4 lg:col-span-2">
            <h2 className="text-h4 font-semibold">Mini toolkit</h2>
