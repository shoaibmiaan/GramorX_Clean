...
export default function StudyPlanPage() {
  ...
  const { current: streak, loading: streakLoading, reload: reloadStreak } = useStreak();
  ...
  const handleTaskToggle = useCallback(
    async (day: StudyDay, taskId: string, checked: boolean) => {
      ...
      try {
        ...
        const shouldRefreshStreak = checked && !wasComplete && !hadOtherCompleted && dayKey === todayKey;
    ...
    [plan, t, userId, persistPlan, reloadStreak, toastError, todayKey],
  );
