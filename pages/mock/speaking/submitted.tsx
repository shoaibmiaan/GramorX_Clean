...
const SpeakingSubmittedPage: NextPage<ModuleSubmittedPageProps> = (props) => <ModuleSubmittedView {...props} />;

export const getServerSideProps: GetServerSideProps<ModuleSubmittedPageProps> = (ctx) =>
  buildModuleSubmittedProps(ctx, 'speaking');

export default SpeakingSubmittedPage;
